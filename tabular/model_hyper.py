...
class Model(object):
  ...
  def train(self, dataset, remaining_time_budget=None):
    ...
    if(self.START):
        ...
        if self.first_round_auc[-1] < auc_score:
        ...
        print("--------------starttrain")
        self.classifier = lgb.train({**params, **self.hyperparams}, train_data, 10, valid_data, init_model=self.second_classifier, early_stopping_rounds=10, 
